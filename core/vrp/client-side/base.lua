...
Citizen.CreateThread(function()
    while true do   
        ...
        SetRichPresence("Jogando Capão Redondo")
        SetDiscordRichPresenceAction(0, "Jogar", "fivem://connect/127.0.0.1:30120")
		SetDiscordRichPresenceAction(1, "Discord", "https://discord.gg/VeZegN9X7F")
        Citizen.Wait(60000)
    end
end)