...
local locais = {
	...
	{ ['id'] = 75, ['x'] = -1421.77, ['y'] = -270.43, ['z'] = 46.31, ['h'] = 44.62 },
	{ ['id'] = 76, ['x'] = -1423.19, ['y'] = -271.67, ['z'] = 46.26, ['h'] = 73.20 }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- ROTEIRO DO ROUBO
-----------------------------------------------------------------------------------------------------------------------------------------
-- RegisterCommand("registradora", function(source,args)
...
-- 				else
-- 					TriggerEvent("Notify","negado","Você não tem permissão para iniciar uma registradora.")
-- 				end
-- 			end
-- 		end
-- 	end
