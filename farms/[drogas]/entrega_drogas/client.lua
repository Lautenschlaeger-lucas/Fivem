	...
	while true do
		...
		if emservico1 then
			...
			if distance <= 50 then
				...
				if distance < 3 then
					skips = 1
					DrawText3Ds(entregasmeta[destinometa].x,entregasmeta[destinometa].y,entregasmeta[destinometa].z, "[H] ENTREGAR")
...
Citizen.CreateThread(function()
	while true do
		local skips = 1000
		if GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()), 331.77865600586,-2220.486328125,12.484232902527,true) <= 1 then
			skips = 1
			DrawText3Ds(331.77865600586,-2220.486328125,12.484232902527+0.5,"PRESSIONE ~r~E~w~ PARA COMEÇAR MISSÃO")
            if IsControlJustPressed(0,38) then	
		...
		if emservico then
			...
			if distance <= 50 then
				...
				if distance < 3 then
					skips = 1
					DrawText3Ds(entregascoca[destinococa].x,entregascoca[destinococa].y,entregascoca[destinococa].z, "[H] ENTREGAR")
                    if IsControlJustPressed(0,101) then
	...
	while true do
		...
		if emservico2 then
			...
			if distance <= 50 then
				...
				if distance < 3 then
					skips = 1
					DrawText3Ds(entregasmaconha[destinomaconha].x,entregasmaconha[destinomaconha].y,entregasmaconha[destinomaconha].z, "[H] ENTREGAR")
